...
const movies = [
 ...
 },
 {
  ...
  category: '剧情',
  rating: 'undefined',
  summary: '上世纪40年代末，沿着马六甲河岸的一带，聚集了许多来此谋生的华人族群，他们在岁月磨难中，同乡互助，顽强拼搏，在立稳脚跟后，一个富有传奇色彩的堂口帮会"山海帮"渐渐成为当地华人的发展中心。故事围绕"山海帮"龙头老大程恢的江湖历险、情仇恩怨展开，本已退隐的他，在"山海帮"遭遇其他帮会挑战时，回到星洲重整帮会。二当家刘雄武被谋杀，背后牵连一系列夺权、地盘争夺、新人上位的阴谋。"山海帮"第二代逐渐崭露头角，带着上一代遗留的问题艰难前行；第三代年轻人也开始冒头。面对殖民者在背后操纵的一系列事件,"山海帮"和这些奉行江湖英雄的人，该何去何从。',
  tags: ['剧情','历史'],
  poster: 'https://i0.hdslb.com/bfs/openplatform/dfbf46cfb7196c4a81537fcf5f1e94e2c9c30a51.png'
 },
 {
  id: 8,
  title: '东京塔',
  ...
  category: '剧情',
  rating: 8.9,
  summary: '20世纪70年代末，生活在福冈县小仓的荣子（倍赏美津子 饰）再也忍受不了丈夫兆治（泉谷茂 饰）的冷淡和婆婆的百般挑剔，带着儿子雅也（速水重道）离家出走，回到了自己的娘家。荣子在自己妹妹经营的餐馆帮忙，为了怕雅也感到寂寞，还为他找来了小伙伴。随后二人又帮到了一座废旧的医院居住，这样一晃十年过去了。雅也到了叛逆期，开始对荣子感到烦躁也对自己的前路感到不安。内心渴望去大城市学画画的他，最后还是踏上了前往东京的列车。而荣子只能在老家省吃俭用的替在东京的雅也祈福。来到东京，让雅也无所适从。前路漫漫，可似乎没有自己可以立足的方向，惟有母亲的牵挂让他坚定活下去的信念……',
  tags: ['剧情'],
  poster: 'https://i0.hdslb.com/bfs/openplatform/ba608f90545b4df1f12ba605ef30b2bfadf2efd6.png'
