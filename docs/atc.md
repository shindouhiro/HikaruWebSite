...
ATC 是一款面向云原生应用的架构图设计工具，具有以下特点：
- 以可视化拖拉拽流程图的方式快速实现应用架构组件的编排、配置、发布
- 可视化展示集群节点资源、应用实例和调度关系
- 采用拖、拉、拽和搭积木的方式，一键拉起整套业务系统，大大提高应用设计及发布效率
- 业务架构可组装：云上微服务应用架构框架可抽象为网关组件、资源形态、注册中心以及可观测能力。ATC 将该四部分框架组装处理，可随意搭配，让您聚焦自身业务形态
