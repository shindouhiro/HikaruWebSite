        ...
        items: [
          {
            ...
            items: [
              ...
              { text: '快速上手', link: '/ai/cursor/getting-started' },
              { text: '常用功能', link: '/ai/cursor/features' },
              { text: '最佳实践', link: '/ai/cursor/best-practices' }
            ]
          },
          {
            text: '智能体',
            items: [
              ...
              { text: '开发指南', link: '/ai/agents/development' },
              { text: '应用案例', link: '/ai/agents/use-cases' }
            ]
          }
        ]
      },
